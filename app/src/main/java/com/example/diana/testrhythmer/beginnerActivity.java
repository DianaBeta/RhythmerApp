...
public class beginnerActivity extends AppCompatActivity {
    ...
    public void fillReference() {
        referenceBeat.clear();
        if (songs.size() == 3) {
            referenceBeat.add((long) 3221);
            referenceBeat.add((long) 4026);
            referenceBeat.add((long) 4831);
            referenceBeat.add((long) 5218);
            referenceBeat.add((long) 5627);
        } else if (songs.size() == 2) {
            referenceBeat.add((long) 3625);
            referenceBeat.add((long) 4022);
            referenceBeat.add((long) 4419);
            referenceBeat.add((long) 5238);
            referenceBeat.add((long) 5616);
            referenceBeat.add((long) 6033);
        } else {
            referenceBeat.add((long) 3506);
            referenceBeat.add((long) 4053);
            referenceBeat.add((long) 4461);
            referenceBeat.add((long) 4860);
            referenceBeat.add((long) 5259);
            referenceBeat.add((long) 5658);
        }
    }
